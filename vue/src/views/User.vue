<template>
  <div style="padding: 10px">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="400">
        <template #default="scope">
          ...
          <el-button size="mini" type="success" plain @click="showBooks(scope.row.bookList)">所属项目列表</el-button>
    ...
    <el-dialog title="用户所属项目列表" v-model="bookVis" width="30%">
      <el-table :data="bookList" stripe border>
        <el-table-column prop="id" label="ID"></el-table-column>
        <el-table-column prop="name" label="项目名称"></el-table-column>
        <el-table-column prop="price" label="项目负责人"></el-table-column>
      </el-table>
    </el-dialog>
