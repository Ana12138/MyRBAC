...
<!--&lt;!&ndash;      <el-button type="primary" @click="add" v-if="user.role === 1">新增</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->

<!--    &lt;!&ndash;    搜索区域&ndash;&gt;-->
<!--&lt;!&ndash;    <div style="margin: 10px 0">&ndash;&gt;-->
<!--&lt;!&ndash;      <el-input v-model="search" placeholder="请输入关键字" style="width: 20%" clearable></el-input>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-button type="primary" style="margin-left: 5px" @click="load">查询</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->
<!--    <el-table-->
<!--        v-loading="loading"-->
<!--        :data="tableData"-->
